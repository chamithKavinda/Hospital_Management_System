    ...
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-center px-4">
        <form noValidate onSubmit={handleSignup} className="md:w-96 w-full flex flex-col items-center justify-center border border-gray-100 rounded-2xl p-10 shadow-sm relative bg-white/90 backdrop-blur-md z-10">
          <h2 className="text-4xl text-gray-900 font-medium">Get Started</h2>
          <p className="text-sm text-gray-500/90 mt-3">Create an account to get started</p>
          ...
          <p className="text-gray-500/90 text-sm mt-4">
            Already have an account? <Link className="text-indigo-400 hover:underline" to="/login">Log In</Link>
          </p>
        </form>
      </div>
    </div>
